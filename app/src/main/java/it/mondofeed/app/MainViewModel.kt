...
class MainViewModel(app: Application) : AndroidViewModel(app) {
    ...
    init {
        // Usa i feed originali del JSON, ma all'avvio carica solo Italia.
    ...
    private fun loadCategory(category: String, force: Boolean = false) {
        ...
        loadingJob = viewModelScope.launch {
            ...
            publishCache("Nessun feed raggiungibile per questa categoria.")
        }
    }
    ...
    private fun loadSource(sourceId: String, force: Boolean = false) {
        ...
        loadingJob = viewModelScope.launch {
            ...
            publishCache("Il feed ${source.name} non è raggiungibile in questo momento.")
        }
    }
